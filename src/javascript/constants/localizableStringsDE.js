module.exports = {
	...
	"QUESTION_BODY_HEAD_OPTIONS" : ["Kopfschmerzen","Erröted","Schwindel und Bennommenheit","Schwerer Kopf","Klarheit","Brennende Augen","Mundtrockenheit","Ohrenschmerzen","Zentriertheit","Klos im Hals","Fieber","Halsschmerz","Sprachlosigkeit","Verwirrung"],
	"QUESTION_BODY_CHEST_OPTIONS" : ["Brustschmerzen","Atemprobleme","Druck auf der Brust","Herzrasen","Rückenschmerzen","Steifheit","Lockerheit","Liebe/Verbundenheit","Nackenschmerzen","Herzflattern","Schulterschmerzen","Herzschmerz","Herzklopfen"],
	"QUESTION_BODY_ABDOMEN_OPTIONS" : ["Schmetterlinge im Bauch","Magenschmerzen","Wohligkeit","Übelkeit","Unterleibsschmerzen","Steifheit","Rückenschmerzen","Völlegefühl"],
	"QUESTION_BODY_LEFT_ARM_OPTIONS" : ["Gelenkschmerzen","Kalte Hände","Warme Hände","Feuchte Hände"],
	"QUESTION_BODY_RIGHT_ARM_OPTIONS" : ["Gelenkschmerzen","Kalte Hände","Warme Hände","Feuchte Hände"],
	"QUESTION_BODY_HIP_OPTIONS" : ["Wohligkeit","Blasen-/Nierenbeschwerden"],
	"QUESTION_BODY_LEFT_LEG_OPTIONS" : ["Gelenkschmerzen","Warme Füße","Kalte Füße","Knieprobleme"],
