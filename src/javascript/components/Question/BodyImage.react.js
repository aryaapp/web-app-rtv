...
let BodyImage = React.createClass({
  ...
  fillColor: function(key) {
    return this.props.body[key].length > 0 ? '#D9D9D9' : '#FAFAFA'
  },
  render() {
    var that = this
    ...
    return (
      <div id="body-image-container">
        <svg version="1.1" id="body-image" viewBox="0 0 180 380">
          ...
          <path id="abdomen" className="body-part" fill={this.fillColor('abdomen')} stroke= { strokeColor } stroke-linejoin="round" stroke-miterlimit="10" d="M119.718,153.389
          ...
          <path id="chest" className="body-part" fill={this.fillColor('chest')} stroke= { strokeColor } stroke-linejoin="round" stroke-miterlimit="10" d="M73.227,121.083h35.972
          ...
          <polyline
            ...
            opacity="0.0"
            pointer-events="all"
            points="63,123 62,123 62,167 138,167 138,123 124,123 "
            onClick={this.props.openBodyModal.bind(null, 'abdomen')}
          />
          <polyline
            id="touch-chest"
            className="touch-area"
            opacity="0.0"
            pointer-events="all"
            points="124,123 124,64 118,64 118,89 68,89 68,64 63,64 63,123 "
            onClick={this.props.openBodyModal.bind(null, 'chest')}
          />
        </svg>
      </div>
